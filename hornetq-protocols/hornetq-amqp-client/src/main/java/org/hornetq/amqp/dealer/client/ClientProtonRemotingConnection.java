...
import org.hornetq.amqp.dealer.utils.ProtonUtils;
...
public class ClientProtonRemotingConnection implements RemotingConnection, MessageCreator<ClientMessageImpl>
{
   ...
   * the input of dealer transport and asynchronously back from HornetQ at the same time.
   ...
   * */
    ...
    *
    * @return
    * @see org.hornetq.amqp.dealer.utils.ProtonUtils
    */
