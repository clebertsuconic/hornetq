...
public final class ChannelImpl implements Channel
{
   ...
   public synchronized void flushConfirmations()
   {
      if (resendCache != null && receivedBytes != 0)
      {
         ...
         if (isTrace)
         {
            HornetQClientLogger.LOGGER.trace("ChannelImpl::flushConfirmation flushing confirmation " + confirmed, new Exception("trace"));
         }
   ...
   public void confirm(final Packet packet)
   {
      if (resendCache != null && packet.isRequiresConfirmations())
      {
         ...
         if (isTrace)
         {
            HornetQClientLogger.LOGGER.trace("ChannelImpl::confirming packet " + packet + " last commandID=" + lastConfirmedCommandID, new Exception("trace"));
         }
